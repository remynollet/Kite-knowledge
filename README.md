...
See [PUBLISHING.md](PUBLISHING.md) for the step-by-step guide to adding new pages.  
See [DEPLOYMENT.md](DEPLOYMENT.md) for the GitHub Pages setup and CI/CD pipeline documentation.  
See [CONTRIBUTING.md](CONTRIBUTING.md) for the AI draft → publication workflow reference.
